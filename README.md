...
```javascript
Complex128Vector = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vector-complex128@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-vector-complex128/tags). For example,

```javascript
Complex128Vector = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vector-complex128@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var Complex128Vector = require( 'path/to/vendor/umd/ndarray-vector-complex128/index.js' )
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-vector-complex128.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-vector-complex128/main
...
[deno-url]: https://github.com/stdlib-js/ndarray-vector-complex128/tree/deno
[deno-readme]: https://github.com/stdlib-js/ndarray-vector-complex128/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-vector-complex128/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-vector-complex128/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-vector-complex128/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-vector-complex128/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/ndarray-vector-complex128/blob/main/branches.md
